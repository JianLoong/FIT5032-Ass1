...
<asp:Content runat="server" ID="Content3" ContentPlaceHolderID="MainContent">
    ...
    <div class="row">
        <div class="col-lg-6">
            <asp:Image CssClass="img-responsive" runat="server" ToolTip="U-Village in Malaysia" ImageUrl="Images/u-village-sungai-wang-01.jpg" />
            <em><strong>Image Courtesy of FoodPoi</strong></em>
        </div>
        <div class="col-lg-6">
